...
# Ramdisk
PRODUCT_COPY_FILES += \
    device/acer/swing/recovery/fstab.swing:recovery/root/fstab.swing \
    device/acer/swing/recovery/recovery.fstab:recovery/root/etc/twrp.fstab
...
# GPS config
PRODUCT_COPY_FILES += \
    device/acer/swing/configs/configs/gps.conf:system/etc/gps.conf
